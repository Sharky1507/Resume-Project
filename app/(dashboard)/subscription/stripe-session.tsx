...
export const postStripeSession = async ({ priceId }: NewSessionOptions) => {
    ...
    if (process.env.NEXT_PUBLIC_DEV_BYPASS_AUTH === 'true') {
        console.log('Stripe checkout bypassed in development mode');
        throw new Error('Stripe checkout not available in development mode');
    }
...
export const createPortalSession = async () => {
    ...
    // Development bypass
    if (process.env.NEXT_PUBLIC_DEV_BYPASS_AUTH === 'true') {
        console.log('Stripe portal bypassed in development mode');
        throw new Error('Stripe billing portal not available in development mode');
    }
